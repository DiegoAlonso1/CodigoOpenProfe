...
public class CommentServiceImpl implements CommentService {
    ...
    public Comment getCommentByIdAndPostId(Long postId, Long commentId) {
        return commentRepository.findByIdAndPostId(commentId, postId).orElseThrow(()->new ResourceNotFoundException("Comment not found with Id " + commentId + " and PostId " + postId));
    }
